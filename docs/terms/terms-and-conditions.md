...
| Template | For |
| --- | --- |
| `KH-Terms-1-on-1.docx` | Weekly or flexi 1-on-1 clients |
| `KH-Terms-2-on-1.docx` | 2-on-1 clients (one per participant) |
| `KH-Terms-3-on-1.docx` | 3-on-1 clients (one per participant) |
| `KH-Terms-Casual.docx` | Casual clients, with or without online coaching |
...
Each row is initialled by the client.
...
- Payment is by weekly direct debit through Ezidebit unless otherwise agreed. Direct deposit can be arranged.
...
| --- | --- |
| Casual session | $143 |
| Casual session, online coaching client | $121 |
| Online coaching | $44 per week |

> Casual sessions are booked as required and carry no minimum term. Online coaching clients receive $22 off each session booked. Clients booking fortnightly or more often should move to a flexi or weekly agreement, which carries lower session rates and app access at $22 per week.
