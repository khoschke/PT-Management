...
create index development_goals_trainer_idx on development_goals (trainer_id, status);
...
create index development_notes_trainer_idx on development_notes (trainer_id, created_at desc);
create index development_notes_goal_idx on development_notes (goal_id, created_at);
