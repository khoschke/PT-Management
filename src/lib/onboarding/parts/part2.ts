  ...
  sections: [
    {
      ...
      body: [
        ...
        "- “To help people feel proud of their bodies, no matter where they're starting from.”",
        "- “To empower people who've felt left out of gyms to find their place and feel confident.”",
        "- “To give others the same mental clarity and physical energy that fitness gave me when I was struggling.”",
        "Some PTs land on their why straight away. Others uncover it slowly through experience and a few setbacks. You can revisit and revise this anytime.",
      ],
      activities: [
        {
          key: "why-drew-you",
    ...
    },
    {
      ...
      body: [
        "Ikigai is a Japanese concept that translates roughly as “a reason for being.” It's the overlap between four questions. Where the four overlap is the work that's energising, valuable, and pays the bills.",
        "- **What you love.** What energises you about coaching and training?",
        "- **What you're good at.** Your skills and strengths. Could be technical (programming) or interpersonal (making people feel safe).",
        "- **What the world needs.** What problems are your clients trying to solve? Where are the gaps you're suited to fill?",
        "- **What you can be paid for.** Your services, packaged and priced in a way that supports your lifestyle.",
        ...
        "Your Ikigai isn't just a workbook exercise. Use it to:",
        "- Guide your mission and purpose statements.",
        "- Clarify who your ideal clients are.",
        "- Refine your services and marketing.",
        "- Stay aligned when business decisions get tricky.",
    ...
    },
    {
      ...
      body: [
        ...
        "When your work aligns with your values, things flow. You feel more energised, more fulfilled, more like yourself. When it doesn't, the work feels heavy.",
        "Say you value creativity and calm. You'll feel more at home in 1:1 coaching or a small studio than in a high-energy group setting. If you thrive on connection and high energy, the opposite. There's no right or wrong. Knowing your values helps you choose your clients, your environment, and how you build your business.",
        "**Step 1. Highlight the values that resonate.** Note any that feel like yours, and add your own below if something important is missing.",
        "| | | | |\n| --- | --- | --- | --- |\n| Achievement | Adventure | Ambition | Authenticity |\n| Balance | Belonging | Boldness | Calm |\n| Challenge | Community | Compassion | Confidence |\n| Connection | Consistency | Courage | Creativity |\n| Curiosity | Dependability | Discipline | Empathy |\n| Empowerment | Excellence | Fairness | Family |\n| Freedom | Fun | Generosity | Gratitude |\n| Growth | Happiness | Health | Honesty |\n| Humility | Humour | Impact | Independence |\n| Innovation | Integrity | Joy | Kindness |\n| Leadership | Learning | Love | Loyalty |\n| Mastery | Mindfulness | Openness | Optimism |\n| Passion | Patience | Peace | Perseverance |\n| Playfulness | Presence | Purpose | Resilience |\n| Respect | Service | Simplicity | Strength |\n| Trust | Vitality | Wellbeing | Wisdom |",
        "**Step 2. Narrow it down.** From the list above, choose your top 5. Which describe how you want to live, coach, or lead?",
        "**Step 3. Reflect.** Explore how your values show up in your coaching now, and where they don't yet.",
        "**Step 4. Action.** Pick one value and write down a small action you can take this week to express it more clearly in your coaching or business.",
      ],
      activities: [
    ...
    },
    {
      ...
      body: [
        ...
        "**Your personal mission** defines who you are as a PT and how you go about your work. For example:",
        "- “I'm committed to helping clients reach their health goals through evidence-based training that's fun and challenging.”",
        "- “I empower clients to reach their full physical potential, on their terms.”",
        "**Your business mission** focuses on what your business offers and the values behind it. For example:",
        "- “My mission is to empower individuals to take control of their health through accessible, professional and results-driven training.”",
        "- “My mission is to deliver personalised fitness solutions that inspire long-term health and wellbeing.”",
        "The difference: your personal mission is about you. Your business mission is about what clients get from you.",
      ],
      activities: [
